...
const defaultStyles: Record<string, string> = {
    ...
    h2: 'scroll-m-20 font-title text-2xl sm:text-3xl tracking-tight first:mt-0',
    h3: 'scroll-m-20 font-title text-xl sm:text-2xl leading-relaxed',
    h4: 'scroll-m-20 font-title text-lg sm:text-xl tracking-tight',
