        ...
        <section className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6 lg:gap-12">
                ...
                <div className="mt-7 lg:mt-0">
                    <motion.div className="mb-2 flex flex-wrap items-center gap-x-3" initial={{ y: -50 }} whileInView={{ y: 0 }} transition={{ type: 'spring', duration: 0.3 }}>
                    ...
                    <Typography as="h2" className={`leading-tight sm:text-[40px]`}>
                        <motion.div initial={{ y: 50 }} whileInView={{ y: 0 }} transition={{ type: 'spring', duration: 0.3 }}>
                            {product.name}
                        </motion.div>
                    </Typography>
                    <Typography as="div" className="mt-6 leading-normal sm:text-base">
                        <motion.p initial={{ y: 50 }} whileInView={{ y: 0 }} transition={{ type: 'spring', duration: 0.4 }}>
                            {product.description}
                        </motion.p>
                    </Typography>

                    <Typography as="div" className="mt-6 font-bold sm:text-2xl">
                        <motion.div initial={{ y: 50 }} whileInView={{ y: 0 }} transition={{ type: 'spring', duration: 0.6 }}>
                    ...
                    <div className="mt-10 flex gap-2 md:gap-5 lg:items-center">
                        <motion.div className="flex items-center gap-3 md:gap-x-5">
                            <motion.div initial={{ x: 50 }} whileInView={{ x: 0 }} whileTap={{ scale: itemQuantity <= 1 ? 1 : 0.95 }} transition={{ type: 'spring', duration: 0.2 }}>
                                <Button
                                    type="button"
                            ...
                            <motion.span className="text-2xl font-semibold" initial={{ x: 50 }} whileInView={{ x: 0 }} transition={{ type: 'spring', duration: 0.3 }}>
                                {itemQuantity}
                            </motion.span>
                            <motion.div
                                initial={{ x: 50 }}
                        ...
                        <motion.div initial={{ x: 50 }} whileInView={{ x: 0 }} transition={{ type: 'spring', duration: 0.5 }}>
                            <AddToCartButton
                                product={product}
