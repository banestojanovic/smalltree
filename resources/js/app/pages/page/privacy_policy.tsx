...
const PrivacyPolicyPage = ({ document }: { document?: string }) => {
            ...
            <div className="container mt-7 max-w-4xl space-y-6 sm:mt-16 lg:space-y-10">
                <div>
                    ...
                    <Typography as="p" className={`text-foreground/80 mt-2 leading-normal sm:mt-4`}>
                        {t('page.privacy_policy.subtitle')}
                    </Typography>
                </div>
...
PrivacyPolicyPage.layout = (page: ReactNode) => <FrontendLayout>{page}</FrontendLayout>;
