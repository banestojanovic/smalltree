...
import CartMobileNavButton from '@/app/components/application/product/CartMobileNavButton';
    ...
    return (
        <>
            <motion.header
                ...
                ref={headerRef}
                className={`bg-background top-auto hidden items-center border-b md:sticky md:top-0 md:z-20 md:flex ${isScrolled ? '' : 'border-transparent'}`}
            >
                <div className="container max-sm:px-2">
                    <div className="hidden items-center gap-x-4 md:flex">
                        <div className={`w-5/12 flex-col flex-wrap gap-4 text-xs lg:flex-row xl:items-center xl:gap-8 xl:text-sm ${isScrolled ? 'hidden md:flex md:flex-row' : 'flex'}`}>
                            <motion.a initial={{ x: 30 }} animate={{ x: 0 }} href="tel:+3801113820466" className="flex items-center gap-x-2">
                            ...
                            <motion.a
                                ...
                                href="mailto:office@smalltree.rs"
                                target="_blank"
                            ...
                            <Link href={route('contact.show')} target="_blank" className="flex items-center gap-x-2">
                                <motion.div className={`flex items-center gap-x-2`} initial={{ x: 30 }} animate={{ x: 0 }} transition={{ delay: 0.15 }}>
                        ...
                        <div className="flex w-2/12 items-center justify-center">
                            <Link href="/">
                                <motion.span
                                    initial={{ height: '6rem', y: -100 }}
                                    animate={{ height: isScrolled ? '3.5rem' : '6rem', y: 0 }}
                                    transition={{
                                        duration: 0.2,
                                        ease: [0, 0.71, 0.2, 1.01],
                                    }}
                    ...
                    <div className="grid grid-cols-2 items-center md:hidden">
                        <Link href="/" className={`relative flex size-full items-center justify-center`}>
                            <motion.span initial={{ y: -30 }} animate={{ y: 0 }}>
                                <ApplicationLogo className="fill-primary flex size-24" />
                            </motion.span>
                        </Link>

                        <div className={`flex flex-col gap-4`}>
                            <motion.a initial={{ y: -20 }} animate={{ y: 0 }} href="tel:+3810113820466" className="flex items-center gap-x-1 text-xs">
                            ...
                            <Link href={route('contact.show')} target="_blank" className="flex items-center gap-x-1 text-xs">
                                <motion.div initial={{ y: -20 }} animate={{ y: 0 }} transition={{ delay: 0.15 }} className={`flex items-center gap-x-1 text-xs`}>
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className={`fixed top-0 right-0 left-0 z-20 grid w-full grid-cols-7 divide-x border-b bg-white md:hidden`}
            >
                <Link href="/" className={`relative flex size-full items-center justify-center`}>
                    <ApplicationLogo className="fill-primary flex size-10" />
                </Link>
                <div>
                    <MobileMenu />
                </div>
                ...
                <div className="flex items-center justify-center">
                    <CartMobileNavButton size={`small`} />
                </div>
