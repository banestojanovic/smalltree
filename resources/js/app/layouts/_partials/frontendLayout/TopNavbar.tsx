    ...
    return (
        <div>
            <div className="container max-sm:px-2">
                <div className="hidden h-32 items-center gap-x-4 md:flex">
                    <div className="flex w-5/12 flex-col flex-wrap gap-4 xl:flex-row xl:items-center xl:gap-8">
                        <a href="tel:+3801113820466" className="flex items-center gap-x-2 text-sm">
                        ...
                        <Link href={route('contact.show')} target="_blank" className="flex items-center gap-x-2 text-sm">
                    ...
                    <div className="flex w-2/12 items-center justify-center">
                        <Link href="/">
                            <ApplicationLogo className="block size-24 fill-primary" />
                        </Link>
                    </div>
                    ...
                    <div className="flex w-5/12 items-center justify-end gap-x-5">
                        <div className="relative transition hover:scale-105">
                            {cart?.products && cart.products.length > 0 && (
                                <Badge variant={'destructive'} className="absolute -right-1 top-0 inline-flex size-5 items-center justify-center rounded-full text-xs">
                                    {cart.products.length}
                                </Badge>
                            )}
                            <Button variant="ghost" size="icon" onClick={openCart} className="inline-flex size-11 items-center justify-center rounded-full bg-white transition-colors">
